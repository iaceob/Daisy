...
window._pr_isIE6 = function() {
    ...
    function O(b) {
        ...
        function l(c) {
            ...
            if (c.ignoreCase && r) for (e = 0; e < a; ++e) {
                ...
                else if (c !== "\\") d[e] = g.replace(/[a-zA-Z]/g,
                    function(s) {
                        s = s.charCodeAt(0);
    ...
    function Y(b) {
        ...
        return function(i) {
            for (var o = null,
                     l = 0,
                     n = 0,
                     r = i.length; n < r; ++n) switch (i.charAt(n)) {
                case "\t":
                    o || (o = []);
    ...
    function B(b, f) {
        var i = {},
            o; (function() {
            for (var r = b.concat(f), j = [], q = {},
                     m = 0, t = r.length; m < t; ++m) {
                var p = r[m],
                    c = p[3];
        ...
        function n(r) {
            for (var j = r.c,
                     q = [j, z], m = 0, t = r.source.match(o) || [], p = {},
    ...
    window.prettyPrint = function(b) {
        function f() {
            for (var t = window.PR_SHOULD_USE_CONTINUATION ? j.now() + 250 : Infinity; q < o.length && j.now() < t; q++) {
                ...
                if (p.className && p.className.indexOf("prettyprint") >= 0) {
                    ...
                    if (c) c = c[1];
                    for (var d = false,
                             a = p.parentNode; a; a = a.parentNode) if ((a.tagName === "pre" || a.tagName === "code" || a.tagName === "xmp") && a.className && a.className.indexOf("prettyprint") >= 0) {
                        d = true;
                        break
                    }
                    if (!d) {
        ...
        for (var i = [document.getElementsByTagName("pre"), document.getElementsByTagName("code"), document.getElementsByTagName("xmp")], o = [], l = 0; l < i.length; ++l) for (var n = 0,
                                                                                                                                                                                     r = i[l].length; n < r; ++n) o.push(i[l][n]);
        i = null;
        var j = Date;
        j.now || (j = {
            now: function() {
